...
struct contracts {
   static std::vector<uint8_t> wps_wasm() { return read_wasm("/Users/yepp4you/Work/blockchain/wps-backend/contracts/build/tests/../../eosio.wps/bin/eosio.wps/eosio.wps.wasm"); }
   static std::string          wps_wast() { return read_wast("/Users/yepp4you/Work/blockchain/wps-backend/contracts/build/tests/../../eosio.wps/bin/eosio.wps/eosio.wps.wast"); }
   static std::vector<char>    wps_abi() { return read_abi("/Users/yepp4you/Work/blockchain/wps-backend/contracts/build/tests/../../eosio.wps/bin/eosio.wps/eosio.wps.abi"); }
